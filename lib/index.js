...
module.exports = constructorOptions => {
  ...
  // 30 seconds
  const defaultTTL = constructorOptions.ttl || ms('30s')
  // prefix
  const defaultTimeout = constructorOptions.timeout || ms('30s')
  // onError
  ...
  return decoratorOptions => {
    ...
    const ttl = isNumberOrString(decoratorOptions.ttl)
    ...
    const pollFactor = decoratorOptions.pollFactor
      || defaultPollFactor
    const minimumPollInterval = ms(decoratorOptions.minimumPollInterval
